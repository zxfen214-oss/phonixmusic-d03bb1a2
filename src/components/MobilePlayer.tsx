...
export default function MobilePlayer({ isOpen, onClose, onOpenLyrics }: MobilePlayerProps) {
  ...
  // Sync displayPlaying with actual isPlaying
  useEffect(() => {
  ...
  const handleLyricsClick = useCallback(() => {
    onClose();
    // Small delay to allow the close animation before opening lyrics
    setTimeout(() => {
      onOpenLyrics();
    }, 150);
        ...
        >
          ...
          <div className="relative z-10 flex flex-col flex-1 px-7 pt-4 pb-8">
            ...
            <div className="mb-5 px-1">
              <div
                className={`relative w-full rounded-full bg-white/20 overflow-visible transition-all duration-150 ${
            ...
            <div className="flex items-center justify-center gap-10 mb-8">
              ...
              <button onClick={handlePlayPause} className="p-2">
                ...
                >
                  <img
                    src={displayPlaying ? iconPause : iconPlay}
                    alt={displayPlaying ? "Pause" : "Play"}
            ...
            <div className="flex items-center justify-center">
              <button onClick={handleLyricsClick} className="p-2">
                <img
                  src={lyricsIcon}
                  alt="Lyrics"
                  className="w-[22px] h-[22px] object-contain invert opacity-80"
                />
              </button>
            </div>
          </div>
